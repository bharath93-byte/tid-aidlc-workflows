...
Examples:
  ...
  python scripts/export_pr_feedback.py --since 2024-01-01 --workers 12

  # Markdown corpus for LLM rule drafting
  python scripts/export_pr_feedback.py --markdown pr-feedback/corpus.md

  # Resume after interruption (skips PRs already in parts/)
  python scripts/export_pr_feedback.py
"""
...
def main() -> None:
    ...
    parser.add_argument("--out-dir", default="./pr-feedback-export")
